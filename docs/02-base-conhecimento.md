...
| Arquivo | Formato | Para que serve no AADSL? |
|---------|---------|---------------------|
...
O produto fundo Imobiliário (FII) substituiu o Fundo Multimercado, pois pessoalmente me sinto mais confiante em usar apenas produtos financeiros que eu conheço. Assim, poderei validar as respostas do AADSL de forma mais assertiva. 
...
transacoes = pd.read_csv('data/transacoes_csv')
...
- Tesouro Selic (risco baico)
- CDB Liquidez Diária (risco baixo)
- LCI/LCA (risco baixo)
- Fundo Imobiliário - FII (risco médio)
- Fundo e Ações (risco alto)
